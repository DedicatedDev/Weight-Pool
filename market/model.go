...
type PoolAsset struct {
	...
	Balance *types.DecCoin `protobuf:"bytes,2,opt,name=balance,proto3" json:"balance,omitempty"`
...
type InterchainLiquidityPool struct {
	...
	Supply                *types.DecCoin `protobuf:"bytes,4,opt,name=supply,proto3" json:"supply,omitempty"`
